...
class Logger(object):
    ...
    def __init__(self,loggername):
        ...
        c = YamlManage('config.yml').get_data('log')
    ...
    def get_logger(self):
        ...
        if  not self.logger.handlers:  # 避免重复日志
            ...
            file_handler = TimedRotatingFileHandler(filename=os.path.join(Path().base_path,"log", self.log_file_name),
                                                    when='D',
                                                    interval=1,
